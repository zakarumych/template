...
[![actions](https://img.shields.io/github/workflow/status/zakarumych/{{project-name}}/Rust/master?style=for-the-badge)](https://github.com/zakarumych/{{project-name}}/actions?query=workflow%3ARust)
